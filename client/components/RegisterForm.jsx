...
export default function RegisterForm() {
  ...
  // Basculer l'affichage du mot de passe entre texte brut et masqué
  ...
  // Empêcher le clic droit d'interférer avec le basculement de l'affichage du mot de passe
  ...
  return (
    ...
    <DefaultLayout>
      ...
      <div className="rounded-sm   bg-white shadow-lg  shadow-lg p-5 rounded-lg border-t-4">
      ...
      {/* {error && ( <div className="bg-red text-white p-4 rounded-lg mt-4">
                ...
                <button
                  type="submit"
                  className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-blue-700 p-4 hover:bg-opacity-50 text-white font-bold transition duration-200 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50 mb-4 mt-4"
                  >
                  Create Account
                </button>
